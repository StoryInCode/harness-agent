...
export const SERVICE_PAGE: Record<string, string> = {
  ...
  devLoopReferences: 'development-loop.md',
  devLoopRoles: 'development-loop.md',
  devLoopWorktree: 'development-loop.md',
...
export const LINK_MAP: Readonly<Record<string, string>> = {
  ...
  DelegationBrief: 'development-loop.md',
  DelegationRecord: 'development-loop.md',
  SettledDelegation: 'development-loop.md',
  ProvenanceObservation: 'development-loop.md',
  QueueEntry: 'development-loop.md',
  WorktreeAssignmentId: 'development-loop.md',
  GitCommit: 'development-loop.md',
  WorktreeAssignment: 'development-loop.md',
  AssignWorktreeRequest: 'development-loop.md',
  WorktreeRetirement: 'development-loop.md',
  Agent: 'core.md',
