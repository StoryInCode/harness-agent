...
| `scripts/gen-doc-graphs.ts` | Development-loop service roles and filesystem/subprocess consumer edges. | The upstream role table is the generator's only classification point; its completeness guard remains enabled. |
