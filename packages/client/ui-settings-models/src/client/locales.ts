...
export const en = {
  ...
  subscriptionTitle: 'Subscription connections',
  subscriptionIntro: 'These providers sign in with your existing subscriptions — a vendor CLI login or Google ADC — instead of an API key.',
  edit: 'Edit',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  subscriptionTitle: '订阅连接',
  subscriptionIntro: '这些提供方通过你已有的订阅登录（厂商 CLI 登录或 Google ADC）鉴权，无需 API 密钥。',
  edit: '编辑',
