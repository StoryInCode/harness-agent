...
需要：`devLoopDirectory` · `devLoopRoles` · `fs` · `storageDomain`
...
来源：[`packages/dev-loop/references/src/types.ts:6`](../packages/dev-loop/references/src/types.ts)
...
来源：[`packages/subagent/subagent-antigravity/src/index.ts:22`](../packages/subagent/subagent-antigravity/src/index.ts)
...
- `@deepseek-ai/dsh-dev-loop-approval` — requires `tools` · `userQuestions` · `devLoopDirectory` · `devLoopLifecycle` · `fs` ([`packages/dev-loop/approval/src/index.ts`](../packages/dev-loop/approval/src/index.ts))
