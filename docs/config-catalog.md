...
Requires: `agents` · `subagents` · `devLoopQueue` · `devLoopWorktree` · `storageDomain`
...
Depends on: [`AgentOptions`](subsystems/core.md) · [`ToolRestriction`](subsystems/tools.md)

Source: [`packages/dev-loop/roles/src/types.ts:51`](../packages/dev-loop/roles/src/types.ts)
